...
"""Provides a DialogBaseInfo class used by the various Info Dialog
subclasses: Dialog*Info  Creates an ActionHandler to respond to
...
class DialogBaseInfo(windows.DialogXML):
    ...
    def open_image(self, control_id:int):
