...
# Modifications copyright (C) 2022/2026 - Scott Smart <scott967@kodi.tv>
# This program is Free Software see LICENSE file for details

"""Main class object run when called by Runplugin() as plugin in Kodi
Note:  Endpoints from Trakt are no longer supported.
"""
